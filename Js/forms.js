...
var countDownDatestart = new Date("January 12, 2023 21:30:00").getTime(); //Set startdate on event it works dont touch 
var countDownDateend = new Date("June 27, 2023 22:35:50").getTime(); //Set enddate on event it works dont touch
