...
<body class="p-0 m-0">
    <ul class="sidenav">
        ...
        <li style="padding-bottom:0px"><a class="font-mono" href="fac.php" target="_self">Faculty Insights</a></li>
    </ul>
    <br />
        ...
        <div class=" bg-[#ffffff] text-center p-3 m-2">
            <div class="chart_con">
                <p class="myfont" style="text-align:left;font-size:1.5rem;padding:1rem;text-decoration:underline">SSS's
                    Forms</p>
                <form method="POST" action="fac_insights.php">
                    <!-- form post method -->
                    <div class="selopt">
                        ...
                        <select name="programme" id="programme">
                            ...
                            $query = "SELECT DISTINCT `department` FROM answerfac;";
...
<script src="../../../Js/fac_departments.js?v=1" type="text/javascript"></script>
