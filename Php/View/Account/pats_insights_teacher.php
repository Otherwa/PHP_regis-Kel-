...
if (isset($_POST["export"])) {
    ...
    for ($a = 11; $a < 29; $a++) {
        ...
        for ($rate = 1; $rate < 8; $rate++) {
            $query = "SELECT COUNT(a" . $a  . ") as count1 from answerpats WHERE tname =\"" . $_POST["teacher"] . "\" AND a" . $a . "=\"" . $rate . "\";";
...
function Get_count()
{
    ...
    $query = "SELECT count(*) as `count1` from `answerpats` WHERE tname=\"" . $_POST['teacher'] . "\" AND programme=\"" . $_POST['Programme'] . "\";";
    $result = mysqli_query($con, $query);
...
<body>
    ...
    <div id="editor" style="display:flex;padding:0.2rem">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <form method="POST" action="down_xl_insights_teacher.php">
            <!-- set tname -->
...
<script src="../../../Js/pats_insights_teacher.js" type="text/javascript"></script>
