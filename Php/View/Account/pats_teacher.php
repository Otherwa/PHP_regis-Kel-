...
<body class="p-0 m-0">
    ...
    <div class="bg-[#ffffff] text-center content" style="padding:0.5rem">
        ...
        <div class=" bg-[#ffffff] text-center p-3 m-2">
            <div class="chart_con">
                <p class="myfont" style="text-align:left;font-size:1.5rem;padding:1rem;text-decoration:underline">PAT's
                    Teacher Insights</p>
                <form method="POST" action="pats_insights_teacher.php">
                    <!-- form post method -->
                    <div class="selopt">
                        ...
                        <select name="teacher" id="teacher" onchange="Get_Chart()">
                            <!-- get ajax -->
                            <option value="--">--</option>
                        </select>
        ...
        <script type="text/javascript" src="../../../Js/pats_teacher.js?v=1"></script>
    </div>
</body>
