...
<body class="p-0 m-0">
    ...
    <div class="bg-[#ffffff] text-center content" style="padding:0.5rem">
        ...
        <div class=" bg-[#ffffff] text-center p-3 m-2">
            <div class="chart_con">
                <p class="myfont" style="text-align:left;font-size:1.5rem;padding:1rem;text-decoration:underline">SSS's
                    Forms</p>
                <form method="POST" action="sss_insights.php">
                    <!-- form post method -->
                    <div class="selopt">
                        <p class="lbl">Programme</p>
                        <select name="programme" id="programme" onchange="Get_Class(this.value)">
                            <?php
                            echo "<option value =\"" . "--" . "\" selected>" . "--" . "</option>";
                            $query = "SELECT DISTINCT `programme` FROM answersss;";
                        ...
                        <p class="lbl">Class</p>
                        <select name="class" id="class" onchange="Get_data(this.value)">
                            <!-- get ajax -->
                            <option value="--">--</option>
                        </select>
                        <br>
...
<script src="../../../Js/sss.js?v=1" type="text/javascript"></script>
