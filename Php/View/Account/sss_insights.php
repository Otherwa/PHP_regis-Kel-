...
if (isset($_POST["export"])) {
    ...
    for ($a = 11; $a < 28; $a++) {
        ...
        for ($rate = 1; $rate < 8; $rate++) {
            $query = "SELECT COUNT(a" . $a  . ") as count1 from answersss WHERE programme =\"" . $_POST["programme"] . "\" AND class=\"" . $_POST["class"] . "\""  . " AND a" . $a . "=\"" . $rate . "\";";
...
function Get_count()
{
    ...
    $query = "SELECT count(*) as `count1` from `answersss` WHERE class=\"" . $_POST['class'] . "\"AND programme =\"" . $_POST['programme'] . "\";";
    $result = mysqli_query($con, $query);
...
<body>
    ...
    <div class="intr">
        <p>
            <?php echo $_POST['programme'] . " - [" . $_POST['class'] . "]"; ?></p>
        <p>
            Total Records :
    ...
    <div id="editor" style="display:flex;padding:0.2rem">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <form method="POST" action="down_xl1.php">
            <!-- set tname -->
