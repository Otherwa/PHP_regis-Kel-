...
if (isset($_POST["export"])) {
    ...
    for ($a = 11; $a < 28; $a++) {
        ...
        for ($rate = 1; $rate < 8; $rate++) {
            $query = "SELECT COUNT(a" . $a  . ") as count1 from answersss WHERE programme =\"" . $_POST["programme"] . "\" AND a" . $a . "=\"" . $rate . "\";";
...
function Get_count()
{
    ...
    $query = "SELECT count(*) as `count1` from `answersss` WHERE programme =\"" . $_POST['programme'] . "\";";
    $result = mysqli_query($con, $query);
