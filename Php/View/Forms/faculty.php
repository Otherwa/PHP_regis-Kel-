        ...
        <form action="#" method="POST" class="form">
            <fieldset>
                ...
                <div class="form__div selectaltered">
                    <label for="department" class="text-sm" style="color:rgb(68, 74, 79)">&squarf; Department:</label>
                ...
                <ol>
                    <li>
                        Wi-Fi facility provided in the college for online classes was effective. Please rate it in the
                        form of percentage of the time it was effective:
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating1_1" value="80%to100%effective">&nbsp; 80% to 100%
                            effective&nbsp;
                            <input type="radio" name="rating1_1" value="60%to80%effective">&nbsp; 60% to 80%
                            effective&nbsp;
                            <input type="radio" name="rating1_1" value="40%to60%effective">&nbsp; 40% to 60%
                            effective&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating1_2" value="Strongly-Agree">&nbsp; Strongly-Agree&nbsp;
                            <input type="radio" name="rating1_2" value="Agree">&nbsp; Agree&nbsp;
                            <input type="radio" name="rating1_2" value="Disagree">&nbsp; Disagree&nbsp;
                            <input type="radio" name="rating1_2" value="Strongly-Disagree">&nbsp;
                            Strongly-Disagree&nbsp;
                        </span>
                    </li>
                ...
                <ol>
                    ...
                    <li>
                        The remuneration/salary that you receive for your services to the college is satisfactory (Only
                ...
                <ol>
                    ...
                    <li>
                        Availability and accessibility of online educational resources in college on library facility is
                        good:
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating2_8" value="Strongly-Agree">&nbsp; Strongly-Agree&nbsp;
                ...
                <div class="form__div ">
                    ...
                    <label for="" class="form__label">Opinins?</label>
                </div>
