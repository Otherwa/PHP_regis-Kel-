            ...
            <fieldset>
                ...
                <ol>
                    <li>
                        ...
                        <br />
                        <ul>
                            <li>Positive and motivating attitude towards students.</li>
                            <li>Readiness to resolve student's doubts and general availability / accessibility to
                                students.Positive and motivating attitude towards students.</li>
                            <li>Worked hard to create a feeling of belongingness in a classroom without walls.</li>
                        </ul>
                        <br />
                        <span class="radio">
                    ...
                    <li>
                        ...
                        <br />
                        <ul>
                            <li>Command over the subject.</li>
                            <li>Skills in making the subject interesting.</li>
                            <li>Command over the medium of instruction(language) / communication skills</li>
                            <li>Clarity in approach / thinking.</li>
                            <li>Punctuality and regularity in taking lectures and practicals.</li>
                            <li>Proficiency in handling online classroom platforms.</li>
                            <li>Time management skill \ skill of completing the syllabus with doubt solving sessions in
                                time.</li>
                        </ul>
                        <br>
                        <span class="radio">
                    ...
                    <li>Additional peripheral skills / activities.
                        <br />
                        <br />
                        <ul>
                            <li>CUse of case studies, illustration, current events, anecdotes in teaching.ommand over
                                the subject.</li>
                            <li>Use of interactive teaching - seminars, tutorials, quizzes, assignments etc.</li>
                            <li>Command over the medium of instruction(language) / communication skills</li>
                            <li>Giving references for further reading..</li>
                            <li>Conducting evaluation by periodic tests / questions answer sessions or by designing
                                quizzes / tests / assignments / examinations and projects to evaluate students.</li>
                            <li>Encouraging students to apply in real life whatever they have learnt in classrooms.</li>
                            <li>Counselling : Career / placement / personal.</li>
                            <li>Stimulating a sense of social responsibility.</li>
                        </ul>
                        <br>
                        <span class="radio">
