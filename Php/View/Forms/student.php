        ...
        <form action="#" method="POST" class="form">
            <fieldset>
                ...
                <div class="form_div">
                    ...
                    <ul>
                        <li>Yes&nbsp;<input type="radio" name="confirm" value="yes"></li>
                        <li>No&nbsp;<input type="radio" name="confirm" value="no"></li>
                    </ul>
                </div>
                <br />
                ...
                <br />
                <ul>
                    <li style="color:red">All questions should be compulsorily attempted. *</li>
                ...
                <ol class="form-ol">
                    <li>
                        ...
                        <span class="radio">
                            ...
                            <input type="radio" name="rating_1" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_1" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_1" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating_2" value="VeryPoor">&nbsp; Very-Poor&nbsp;
                            <input type="radio" name="rating_2" value="Poor">&nbsp; Poor&nbsp;
                            <input type="radio" name="rating_2" value="BelowAverage">&nbsp; Below-Average&nbsp;
                            <input type="radio" name="rating_2" value="Average">&nbsp; Average&nbsp;
                            <input type="radio" name="rating_2" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_2" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_2" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating_3" value="VeryPoor">&nbsp; Very-Poor&nbsp;
                            <input type="radio" name="rating_3" value="Poor">&nbsp; Poor&nbsp;
                            <input type="radio" name="rating_3" value="BelowAverage">&nbsp; Below-Average&nbsp;
                            <input type="radio" name="rating_3" value="Average">&nbsp; Average&nbsp;
                            <input type="radio" name="rating_3" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_3" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_3" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating_4" value="VeryPoor">&nbsp; Very-Poor&nbsp;
                            <input type="radio" name="rating_4" value="Poor">&nbsp; Poor&nbsp;
                            <input type="radio" name="rating_4" value="BelowAverage">&nbsp; Below-Average&nbsp;
                            <input type="radio" name="rating_4" value="Average">&nbsp; Average&nbsp;
                            <input type="radio" name="rating_4" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_4" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_4" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating_5" value="VeryPoor">&nbsp; Very-Poor&nbsp;
                            <input type="radio" name="rating_5" value="Poor">&nbsp; Poor&nbsp;
                            <input type="radio" name="rating_5" value="BelowAverage">&nbsp; Below-Average&nbsp;
                            <input type="radio" name="rating_5" value="Average">&nbsp; Average&nbsp;
                            <input type="radio" name="rating_5" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_5" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_5" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="radio">
                            <input type="radio" name="rating_6" value="VeryPoor">&nbsp; Very-Poor&nbsp;
                            <input type="radio" name="rating_6" value="Poor">&nbsp; Poor&nbsp;
                            <input type="radio" name="rating_6" value="BelowAverage">&nbsp; Below-Average&nbsp;
                            <input type="radio" name="rating_6" value="Average">&nbsp; Average&nbsp;
                            <input type="radio" name="rating_6" value="Good">&nbsp; Good&nbsp;
                            <input type="radio" name="rating_6" vlaue="VeryGood">&nbsp; Very-Good&nbsp;
                            <input type="radio" name="rating_6" value="Excellent">&nbsp; Excellent&nbsp;
                        </span>
                    </li>
                    ...
                    <li>
                        Library facility in college(Availability and accessibility of online educational resources in
                        college.):
                        <br />
                        <br />
                        <span class="radio">
